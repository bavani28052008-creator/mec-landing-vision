  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-coral': 'linear-gradient(135deg, hsl(var(--gradient-coral-from)), hsl(var(--gradient-coral-to)))',
        ...
        'gradient-yellow': 'linear-gradient(135deg, hsl(var(--gradient-yellow-from)), hsl(var(--gradient-yellow-to)))',
